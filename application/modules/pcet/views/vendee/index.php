<div class="admin-box">
	<h3><?php echo lang('pcet'); ?> en Vendée</h3>
				...
				<tr>
					...
					<td><?php e($record->NOM_PHASE) ?></td>
                                        <td width="10%">
                                            ...
                                            <?php echo anchor(SITE_AREA .'/vendee/actions/dashboard/'. $record->ID_PCET, '<i class="icon-info-sign">&nbsp;</i>Voir le tableau de bord') ?><br />
