	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="control-group <?php echo form_error('ID_PCET') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					<input id='pcet_ID_PCET' type='text' name='pcet_ID_PCET' maxlength="10" value="<?php echo set_value('pcet_ID_PCET', isset($pcet['ID_PCET']) ? $pcet['ID_PCET'] : 'PCET72-'); ?>" />
			...
			<div class="form-actions">
				...
				ou <?php echo anchor(SITE_AREA .'/sarthe/pcet', lang('pcet_cancel'), 'class="btn btn-warning"'); ?>
