			...
			<?php foreach ($records as $record) : ?>
				<tr>
					...
					<td><?php e($record->NOM_PHASE) ?></td>
                                        <td width="10%">
                                            <?php echo anchor(SITE_AREA .'/loireatlantique/pcet/show/'. $record->ID_PCET, '<i class="icon-info-sign">&nbsp;</i>Voir la fiche') ?><br />
                                            <?php echo anchor(SITE_AREA .'/loireatlantique/actions/dashboard/'. $record->ID_PCET, '<i class="icon-info-sign">&nbsp;</i>Voir le tableau de bord') ?><br />
