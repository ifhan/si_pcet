...
class mayenne extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('PCET.Mayenne.View');
	...
	*/
	public function index()
	{
		...
		$records = $this->pcet_model->get_pcet_by_departement('53');
	...
	*/
	...
	{
		$this->auth->restrict('PCET.Mayenne.Create');
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('PCET.Mayenne.Edit');
		...
		{
			$this->auth->restrict('PCET.Mayenne.Delete');
