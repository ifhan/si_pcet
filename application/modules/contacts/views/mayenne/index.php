<div class="admin-box">
	<h3><?php echo lang('contacts_title');  ?>Mayenne</h3>
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('Contacts.Mayenne.Delete') && isset($records) && is_array($records) && count($records)) : ?>
			...
			<tfoot>
				<?php if ($this->auth->has_permission('Contacts.Mayenne.Delete')) : ?>
				<tr>
					<td colspan="7">
			...
			<?php foreach ($records as $record) : ?>
				...
				<td>
                                ...
                                <?php if ($this->auth->has_permission('Contacts.Mayenne.Edit')) : ?>
				<td><?php echo anchor(SITE_AREA .'/mayenne/contacts/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>Modifier') ?></td>
				<?php else: ?>
