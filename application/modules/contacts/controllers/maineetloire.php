...
class maineetloire extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Contacts.Maineetloire.View');
	...
	*/
	public function index()
	{
		...
		$records = $this->contacts_model->get_contacts_by_departement('49');
	...
	*/
	...
	{
		$this->auth->restrict('Contacts.Maineetloire.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_contacts())
			{
				...
				redirect(SITE_AREA .'/maineetloire/contacts');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Contacts.Maineetloire.Edit');
		...
		{
			$this->auth->restrict('Contacts.Maineetloire.Delete');
