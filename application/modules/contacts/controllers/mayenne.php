...
class mayenne extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Contacts.Mayenne.View');
	...
	*/
	public function index()
	{
		...
		$records = $this->contacts_model->get_contacts_by_departement('53');
	...
	*/
	...
	{
		$this->auth->restrict('Contacts.Mayenne.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_contacts())
			{
				...
				redirect(SITE_AREA .'/mayenne/contacts');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Contacts.Mayenne.Edit');
		...
		{
			$this->auth->restrict('Contacts.Mayenne.Delete');
