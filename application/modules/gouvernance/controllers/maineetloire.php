...
class maineetloire extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Gouvernance.Maineetloire.View');
	...
	*/
	public function index()
	{
		...
		$records = $this->gouvernance_model->get_gouvernance_by_departement('49');
	...
	*/
	...
	{
		$this->auth->restrict('Gouvernance.Maineetloire.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_gouvernance())
			{
				...
				redirect(SITE_AREA .'/maineetloire/gouvernance');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Gouvernance.Maineetloire.Edit');
		...
		{
			$this->auth->restrict('Gouvernance.Maineetloire.Delete');
