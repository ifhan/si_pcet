...
class vendee extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Gouvernance.Vendee.View');
	...
	*/
	public function index()
	{
		...
		$records = $this->gouvernance_model->get_gouvernance_by_departement('85');
	...
	*/
	...
	{
		$this->auth->restrict('Gouvernance.Vendee.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_gouvernance())
			{
				...
				redirect(SITE_AREA .'/vendee/gouvernance');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Gouvernance.Vendee.Edit');
		...
		{
			$this->auth->restrict('Gouvernance.Vendee.Delete');
