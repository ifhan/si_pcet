...
class sarthe extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Gouvernance.Sarthe.View');
	...
	*/
	public function index()
	{
		...
		$records = $this->gouvernance_model->get_gouvernance_by_departement('72');
	...
	*/
	...
	{
		$this->auth->restrict('Gouvernance.Sarthe.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_gouvernance())
			{
				...
				redirect(SITE_AREA .'/sarthe/gouvernance');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Gouvernance.Sarthe.Edit');
		...
		{
			$this->auth->restrict('Gouvernance.Sarthe.Delete');
