...
class loireatlantique extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Gouvernance.Loireatlantique.View');
	...
	*/
	public function index()
	{
		...
		$records = $this->gouvernance_model->get_gouvernance_by_departement('44');
	...
	*/
	...
	{
		$this->auth->restrict('Gouvernance.Loireatlantique.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_gouvernance())
			{
				...
				redirect(SITE_AREA .'/loireatlantique/gouvernance');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Gouvernance.Loireatlantique.Edit');
		...
		{
			$this->auth->restrict('Gouvernance.Loireatlantique.Delete');
