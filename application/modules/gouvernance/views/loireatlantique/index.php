<div class="admin-box">
	<h3><?php echo lang('gouvernance_title'); ?>Loire-Atlantique</h3>
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('Gouvernance.Loireatlantique.Delete') && isset($records) && is_array($records) && count($records)) : ?>
					...
					<?php endif; ?>
                                    ...
                                    <td>
                                        <?php if ($this->auth->has_permission('Gouvernance.Loireatlantique.Edit')) : ?>
                                            <?php echo anchor(SITE_AREA .'/loireatlantique/gouvernance/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>Modifier') ?>
                                        <?php endif; ?>
                                    </td>
				</tr>
			<?php endforeach; ?>
