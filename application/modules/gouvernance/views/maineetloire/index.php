<div class="admin-box">
	<h3><?php echo lang('gouvernance_title'); ?>Maine-et-Loire</h3>
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('Gouvernance.Maineetloire.Delete') && isset($records) && is_array($records) && count($records)) : ?>
