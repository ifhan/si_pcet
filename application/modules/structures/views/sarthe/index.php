<div class="admin-box">
	<h3>Liste des collectivit&eacute;s porteuses de PCET en Sarthe</h3>
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<?php foreach ($records as $record) : ?>
				...
				<td><?php echo anchor(SITE_AREA .'/sarthe/structures/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>' .  $record->ID_STR) ?></td>
				<?php else: ?>
