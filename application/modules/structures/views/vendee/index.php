				...
				<tr>
					...
					<td>
                                            <?php if ($this->auth->has_permission('Structures.Vendee.Edit')) : ?>
                                                <?php echo anchor(SITE_AREA .'/vendee/structures/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>Modifier') ?><br />
                                            <?php endif; ?>
                                            <?php echo anchor(SITE_AREA .'/vendee/contacts/show/'. $record->ID_STR, '<i class="icon-envelope">&nbsp;</i>Voir les contacts') ?>
                                        </td>
				</tr>
			<?php endforeach; ?>
			<?php else: ?>
