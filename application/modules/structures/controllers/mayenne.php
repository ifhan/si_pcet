...
class mayenne extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Structures.Mayenne.View');
	...
	*/
	public function index()
	{
		...
		$records = $this->structures_model->get_structures_by_departement('53');
	...
	*/
	...
	{
		$this->auth->restrict('Structures.Mayenne.Create');
		$communes = $this->communes_model->get_communes_by_departement('53');
		$departements = $this->departements_model->get_departement_by_insee_departement('53');
		$communautes_agglomeration = $this->epci_model->get_epci_by_departement_by_type("02453",'1');
		$communautes_urbaines = $this->epci_model->get_epci_by_departement_by_type("02453",'2');
		$communautes_communes = $this->epci_model->get_epci_by_departement_by_type("02453",'4');
		$array_pays = $this->pays_model->get_pays_by_departement('53');
		$array_pnr = $this->pnr_model->get_pnr_by_departement('53');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_structures())
			{
				...
				redirect(SITE_AREA .'/mayenne/structures');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Structures.Mayenne.Edit');
		...
		{
			$this->auth->restrict('Structures.Mayenne.Delete');
