...
class vendee extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Engagement.Vendee.View');
	...
	*/
	public function index()
	{
		...
		$records = $this->engagement_model->get_engagement_by_departement('85');
	...
	*/
	...
	{
		$this->auth->restrict('Engagement.Vendee.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_engagement())
			{
				...
				redirect(SITE_AREA .'/vendee/engagement');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Engagement.Vendee.Edit');
		...
		{
			$this->auth->restrict('Engagement.Vendee.Delete');
