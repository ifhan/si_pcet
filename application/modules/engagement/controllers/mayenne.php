...
class mayenne extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Engagement.Mayenne.View');
	...
	*/
	public function index()
	{
		...
		$records = $this->engagement_model->get_engagement_by_departement('53');
	...
	*/
	...
	{
		$this->auth->restrict('Engagement.Mayenne.Create');
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Engagement.Mayenne.Edit');
		...
		{
			$this->auth->restrict('Engagement.Mayenne.Delete');
