		...
		<table class="table table-striped">
			...
			<?php foreach ($records as $record) : ?>
				<tr>
                                    ...
                                    <td width="20%">
                                        <?php echo anchor(SITE_AREA .'/loireatlantique/engagement/show/'. $record->id, '<i class="icon-info-sign">&nbsp;</i>Voir l\'engagement de la démarche') ?><br />
                                        <?php if ($this->auth->has_permission('Engagement.Loireatlantique.Edit')) : ?>
                                            <?php echo anchor(SITE_AREA .'/loireatlantique/engagement/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>Modifier') ?><br />
                                        <?php endif; ?>     
                                    </td>
				</tr>
			<?php endforeach; ?>
