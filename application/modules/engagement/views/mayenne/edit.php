	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="control-group <?php echo form_error('COMMENT_DDT') ? 'error' : ''; ?>">
				<?php echo form_label('Implication de la DDT(M)', 'engagement_COMMENT_DDT', array('class' => 'control-label') ); ?>
				<div class='controls'>
			...
			<div class="control-group <?php echo form_error('REP_USH') ? 'error' : ''; ?>">
				<?php echo form_label('Consultation aval USH souhaitée ?', 'engagement_REP_USH', array('class' => 'control-label') ); ?>
				<div class='controls'>
			...
			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('engagement_action_edit'); ?>"  />
				ou <?php echo anchor(SITE_AREA .'/mayenne/engagement', lang('engagement_cancel'), 'class="btn btn-warning"'); ?>
				
			<?php if ($this->auth->has_permission('Engagement.Mayenne.Delete')) : ?>
				ou
				<button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php e(js_escape(lang('engagement_delete_confirm'))); ?>'); ">
					<span class="icon-trash icon-white"></span>&nbsp;<?php echo lang('engagement_delete_record'); ?>
				</button>
			<?php endif; ?>
			</div>
		</fieldset>
