...
class vendee extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Adaptation.Vendee.View');
	...
	*/
	...
	{
		$this->auth->restrict('Adaptation.Vendee.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_adaptation())
			{
				...
				redirect(SITE_AREA .'/vendee/adaptation');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Adaptation.Vendee.Edit');
		...
		{
			$this->auth->restrict('Adaptation.Vendee.Delete');
