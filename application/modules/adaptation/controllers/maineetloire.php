...
class maineetloire extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Adaptation.Maineetloire.View');
	...
	*/
	public function index()
	{
		...
		$records = $this->adaptation_model->get_etude_vulnerabilite_by_departement('49');
	...
	*/
	...
	{
		$this->auth->restrict('Adaptation.Maineetloire.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_adaptation())
			{
				...
				redirect(SITE_AREA .'/maineetloire/adaptation');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Adaptation.Maineetloire.Edit');
		...
		{
			$this->auth->restrict('Adaptation.Maineetloire.Delete');
