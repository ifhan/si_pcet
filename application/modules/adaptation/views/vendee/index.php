<div class="admin-box">
	<h3><?php echo lang('adaptation_title'); ?>Vendée</h3>
			...
			<?php foreach ($records as $record) : ?>
				<tr>
					...
					<?php endif;?>
                                    ...
                                    <td width="20%">
                                        <?php echo anchor(SITE_AREA .'/vendee/adaptation/show/'. $record->id, '<i class="icon-info-sign">&nbsp;</i>Voir le volet "Adaptation"') ?><br />
                                        <?php if ($this->auth->has_permission('Adaptation.Vendee.Edit')) : ?>
                                            <?php echo anchor(SITE_AREA .'/vendee/adaptation/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>Modifier') ?><br />
                                        <?php endif; ?>     
                                    </td>
				</tr>
			<?php endforeach; ?>
