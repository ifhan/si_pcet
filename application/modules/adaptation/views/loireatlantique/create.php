...
<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
                        ...
                        <?php if(isset($pcets)): ?>
                            <?php echo form_dropdown('adaptation_ID_PCET',$pcets,set_value('indicateur_ID_PCET', isset($pcets['ID_PCET']) ? $pcets['ID_PCET'] : ''),'Sélectionner un PCET');?>
                        <?php else: ?>
			...
			<div class="form-actions">
				...
				ou <?php echo anchor(SITE_AREA .'/loireatlantique/adaptation', lang('adaptation_cancel'), 'class="btn btn-warning"'); ?>
