		...
		<fieldset>
			...
			<?php echo form_dropdown('diagnostic_ID_PCET',$pcets,set_value('diagnostic_ID_PCET', isset($pcets['ID_PCET']) ? $pcets['ID_PCET'] : ''),'Sélectionner un PCET');?>
                        ...
                        <div class="control-group">
                            <div class='controls'>
                                <span>ou</span> <a href="<?php echo site_url(SITE_AREA .'/sarthe/pcet/create') ?>" class="btn" type="button">Ajouter un PCET</a>
			...
			<div class="form-actions">
				...
				ou <?php echo anchor(SITE_AREA .'/sarthe/diagnostic', lang('diagnostic_cancel'), 'class="btn btn-warning"'); ?>
