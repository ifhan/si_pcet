...
<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<?php echo form_dropdown('diagnostic_ID_GES_BILAN_T',$scope, set_value('diagnostic_ID_GES_BILAN_T', isset($scope['ID_GES_BILAN_T']) ? $scope['ID_GES_BILAN_T'] : ''), 'Scope du bilan GES territorial'); ?>

			<?php echo form_dropdown('diagnostic_ID_GES_BILAN_PC',$scope, set_value('diagnostic_ID_GES_BILAN_PC', isset($scope['ID_GES_BILAN_PC']) ? $scope['ID_GES_BILAN_PC'] : ''), 'Scope du bilan GES "Patrimoine et Compétence"'); ?>

			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('diagnostic_action_create'); ?>"  />
				or <?php echo anchor(SITE_AREA .'/loireatlantique/diagnostic', lang('diagnostic_cancel'), 'class="btn btn-warning"'); ?>
