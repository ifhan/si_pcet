...
class vendee extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Diagnostic.Vendee.View');
	...
	public function create()
	{
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_diagnostic())
			{
				...
				redirect(SITE_AREA .'/vendee/diagnostic');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Diagnostic.Vendee.Edit');
		...
		{
			$this->auth->restrict('Diagnostic.Vendee.Delete');
