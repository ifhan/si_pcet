...
class maineetloire extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Diagnostic.Maineetloire.View');
	...
	*/
	public function index()
	{
		...
		$records = $this->diagnostic_model->get_diagnostic_by_departement('49');
	...
	*/
	...
	{
		$this->auth->restrict('Diagnostic.Maineetloire.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_diagnostic())
			{
				...
				redirect(SITE_AREA .'/maineetloire/diagnostic');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Diagnostic.Maineetloire.Edit');
		...
		{
			$this->auth->restrict('Diagnostic.Maineetloire.Delete');
