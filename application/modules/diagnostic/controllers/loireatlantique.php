...
class loireatlantique extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Diagnostic.Loireatlantique.View');
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Diagnostic.Loireatlantique.Edit');
		...
		{
			$this->auth->restrict('Diagnostic.Loireatlantique.Delete');
