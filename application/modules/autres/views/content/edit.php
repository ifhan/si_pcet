...
<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
                        ...
                        <?php echo form_dropdown('autres_DEPARTEMENT_id',$departements, set_value('autres_DEPARTEMENT_id', isset($autres['DEPARTEMENT_id']) ? $autres['DEPARTEMENT_id'] : ''),'Département'); ?>
