...
?>
<div class="admin-box">
	<h3><?php echo lang('pages_create')?></h3>
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="control-group <?php echo form_error('pages_title') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					<input id='pages_title' type='text' name='pages_title' maxlength="255" class="input-xxlarge" value="<?php echo set_value('pages_title', isset($pages['pages_title']) ? $pages['pages_title'] : ''); ?>" />
