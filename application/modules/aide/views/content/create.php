...
?>
<div class="admin-box">
	<h3><?php echo lang('aide_create') ?></h3>
		...
		<fieldset>
			...
			<div class="control-group <?php echo form_error('slug') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					...
					<input id='aide_slug' type='text' name='aide_slug' maxlength="255" class="input-xlarge" value="<?php echo set_value('aide_slug', isset($aide['slug']) ? $aide['slug'] : ''); ?>" />
