...
class mayenne extends Admin_Controller {
	...
	*/
	public function index()
	{
		...
		$records = $this->avis_model->get_avis_by_departement('53');
	...
	*/
	...
	{
		$this->auth->restrict('Avis.Mayenne.Create');
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Avis.Mayenne.Edit');
		...
		{
			$this->auth->restrict('Avis.Mayenne.Delete');
