...
class vendee extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Avis.Vendee.View');
	...
	*/
	public function index()
	{
		...
		$records = $this->avis_model->get_avis_by_departement('85');
	...
	*/
	...
	{
		$this->auth->restrict('Avis.Vendee.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_avis())
			{
				...
				redirect(SITE_AREA .'/vendee/avis');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Avis.Vendee.Edit');
		...
		{
			$this->auth->restrict('Avis.Vendee.Delete');
