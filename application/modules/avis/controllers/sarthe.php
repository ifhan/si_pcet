...
class sarthe extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Avis.Sarthe.View');
	...
	*/
	public function index()
	{
		...
		$records = $this->avis_model->get_avis_by_departement('72');
	...
	*/
	...
	{
		$this->auth->restrict('Avis.Sarthe.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_avis())
			{
				...
				redirect(SITE_AREA .'/sarthe/avis');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Avis.Sarthe.Edit');
		...
		{
			$this->auth->restrict('Avis.Sarthe.Delete');
