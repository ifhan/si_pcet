<div class="admin-box">
	<h3><?php echo lang('avis_title') ?>Loire-Atlantique</h3>
		...
		<table class="table table-striped">
			...
			<?php foreach ($records as $record) : ?>
				...
				<td>
                                    ...
                                    <td width="20%">
                                        <?php echo anchor(SITE_AREA .'/loireatlantique/avis/show/'. $record->id, '<i class="icon-info-sign">&nbsp;</i>Voir le suivi des avis') ?><br />
                                        <?php if ($this->auth->has_permission('Avis.Loireatlantique.Edit')) : ?>
                                            <?php echo anchor(SITE_AREA .'/loireatlantique/avis/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>Modifier') ?><br />
                                        <?php endif; ?>     
                                    </td>
