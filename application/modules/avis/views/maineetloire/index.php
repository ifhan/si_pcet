		...
		<table class="table table-striped">
			...
			<?php foreach ($records as $record) : ?>
				<tr>
                                    ...
                                    <td width="20%">
                                        <?php echo anchor(SITE_AREA .'/maineetloire/avis/show/'. $record->id, '<i class="icon-info-sign">&nbsp;</i>Voir le suivi des avis') ?><br />
                                        <?php if ($this->auth->has_permission('Avis.Maineetloire.Edit')) : ?>
                                            <?php echo anchor(SITE_AREA .'/maineetloire/avis/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>Modifier') ?><br />
                                        <?php endif; ?>     
                                    </td>
				</tr>
			<?php endforeach; ?>
