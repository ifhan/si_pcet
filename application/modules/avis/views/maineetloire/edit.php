...
?>
<div class="admin-box">
	<h3>Modifier le suivi des avis</h3>
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>

			<?php echo form_dropdown('avis_ID_PCET',$pcets,set_value('avis_ID_PCET', isset($avis['ID_PCET']) ? $avis['ID_PCET'] : ''),'Sélectionner un PCET');?>
			...
			<div class="form-actions">
				...
				ou <?php echo anchor(SITE_AREA .'/maineetloire/avis', lang('avis_cancel'), 'class="btn btn-warning"'); ?>
