...
class mayenne extends Admin_Controller {
	...
	*/
	public function index()
	{
		...
		$records = $this->actions_model->get_actions_by_departement('53');
	...
	*/
	...
	{
		$this->auth->restrict('Actions.Mayenne.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_actions())
			{
				...
				redirect(SITE_AREA .'/mayenne/actions');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Actions.Mayenne.Edit');
		...
		{
			$this->auth->restrict('Actions.Mayenne.Delete');
