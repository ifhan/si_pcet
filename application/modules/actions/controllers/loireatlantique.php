...
class loireatlantique extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Actions.Loireatlantique.View');
	...
	*/
	public function index()
	{
		...
		$records = $this->actions_model->get_actions_by_departement('44');
	...
	*/
	...
	{
		$this->auth->restrict('Actions.Loireatlantique.Create');
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Actions.Loireatlantique.Edit');
		...
		{
			$this->auth->restrict('Actions.Loireatlantique.Delete');
