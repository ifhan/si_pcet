...
class vendee extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Actions.Vendee.View');
	...
	*/
	public function index()
	{
		...
		$records = $this->actions_model->get_actions_by_departement('85');
	...
	*/
	...
	{
		$this->auth->restrict('Actions.Vendee.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_actions())
			{
				...
				redirect(SITE_AREA .'/vendee/actions');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Actions.Vendee.Edit');
		...
		{
			$this->auth->restrict('Actions.Vendee.Delete');
