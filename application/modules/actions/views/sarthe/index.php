					...
					<?php endif;?>
                                    ...
                                    <td width="20%">
                                        <?php if ($this->auth->has_permission('Actions.Sarthe.Edit')) : ?>
                                            <?php echo anchor(SITE_AREA .'/sarthe/actions/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>Modifier') ?><br />
                                        <?php endif; ?> 
                                        <?php echo anchor(SITE_AREA .'/sarthe/actions/show/'. $record->id, '<i class="icon-info-sign">&nbsp;</i>Voir l\'action') ?><br />
                                        <?php echo anchor(SITE_AREA .'/sarthe/actions/show/'. $record->ID_PCET, '<i class="icon-info-sign">&nbsp;</i>Voir le tableau de bord du PCET') ?>
                                    </td>
				</tr>
				</tr>
			<?php endforeach; ?>
