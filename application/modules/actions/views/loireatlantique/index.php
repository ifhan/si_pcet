<div class="admin-box">
	<h3><?php echo lang('actions_title'); ?>Loire-Atlantique</h3>
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('Actions.Loireatlantique.Delete') && isset($records) && is_array($records) && count($records)) : ?>
			...
			<?php foreach ($records as $record) : ?>
				<tr>
                                    ...
                                    <td width="20%">
                                        <?php echo anchor(SITE_AREA .'/loireatlantique/actions/dashboard/'. $record->ID_PCET, '<i class="icon-info-sign">&nbsp;</i>Voir le tableau de bord du PCET') ?><br />
