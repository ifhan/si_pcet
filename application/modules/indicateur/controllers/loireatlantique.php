...
class loireatlantique extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Indicateur.Loireatlantique.View');
	...
	*/
	public function index()
	{
		...
		$records = $this->indicateur_model->find_all();
                $records = $this->indicateur_model->get_indicateur_by_departement('44');
	...
	*/
	...
	{
		$this->auth->restrict('Indicateur.Loireatlantique.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_indicateur())
			{
				...
				redirect(SITE_AREA .'/loireatlantique/indicateur');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Indicateur.Loireatlantique.Edit');
		...
		{
			$this->auth->restrict('Indicateur.Loireatlantique.Delete');
