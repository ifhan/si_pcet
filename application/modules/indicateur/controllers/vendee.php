...
class vendee extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Indicateur.Vendee.View');
	...
	*/
	public function index()
	{
		...
		$records = $this->indicateur_model->find_all();
                $records = $this->indicateur_model->get_indicateur_by_departement('85');
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Indicateur.Vendee.Edit');
		...
		{
			$this->auth->restrict('Indicateur.Vendee.Delete');
