...
class maineetloire extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Indicateur.Maineetloire.View');
	...
	*/
	...
	{
		$this->auth->restrict('Indicateur.Maineetloire.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_indicateur())
			{
				...
				redirect(SITE_AREA .'/maineetloire/indicateur');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Indicateur.Maineetloire.Edit');
		...
		{
			$this->auth->restrict('Indicateur.Maineetloire.Delete');
