...
?>
<div class="admin-box">
	<h3><?php echo lang('indicateur_edit'); ?></h3>
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>

			<?php echo form_dropdown('indicateur_ID_PCET',$pcets,set_value('indicateur_ID_PCET', isset($indicateur['ID_PCET']) ? $indicateur['ID_PCET'] : ''),'Sélectionner un PCET');?>
			...
			<div class="form-actions">
				...
				or <?php echo anchor(SITE_AREA .'/loireatlantique/indicateur', lang('indicateur_cancel'), 'class="btn btn-warning"'); ?>
