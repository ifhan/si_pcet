<div class="row">
	...
	<div class="column size1of4 media-box">
		<a href="<?php echo site_url(SITE_AREA .'/settings/activities/activity_own') ?>">
	...
	<div class="column size1of4  media-box">
		<a href="<?php echo site_url(SITE_AREA .'/settings/activities/activity_user') ?>">
	...
	<div class="column size1of4  media-box">
		<a href="<?php echo site_url(SITE_AREA .'/settings/activities/activity_module') ?>">
	...
	<div class="column size1of4 media-box">
		<a href="<?php echo site_url(SITE_AREA .'/settings/activities/activity_date') ?>">
...
<div class="admin-box">
	...
	<table class="table table-striped">
		<tbody>
			...
			<tr>
				<td>
					<?php echo form_open(SITE_AREA .'/settings/activities/delete', array('id' => 'activity_own_form')); ?>
			...
			<tr>
				<td>
					<?php echo form_open(SITE_AREA .'/settings/activities/delete', array('id' => 'activity_user_form')); ?>
			...
			<tr>
				<td>
					<?php echo form_open(SITE_AREA .'/settings/activities/delete', array('id' => 'activity_module_form')); ?>
			...
			<tr>
				<td>
					<?php echo form_open(SITE_AREA .'/settings/activities/delete', array('id' => 'activity_date_form')); ?>
